...
public class StarLauncherBootstrap implements ModInitializer {
	...
	public void onInitialize() {
		ServerPlayNetworking.registerGlobalReceiver(CHANGE_STAR_MODE_PACKET_ID,
				...
				server.execute(() -> {
					...
					player.method_7353(
						class_2561.method_43470(
							"\u00a7d[\u0417\u0432\u0451\u0437\u0434\u043d\u044b\u0439 \u0432\u044b\u043f\u0443\u0441\u043a\u0430\u0442\u0435\u043b\u044c] \u00a7r\u0420\u0435\u0436\u0438\u043c: " + StarLauncherItem.getModeShortName(mode)
						),
						true
					);
				});
	...
	public static boolean isStarLauncherStack(class_1799 stack) {
		...
		try {
			...
			return id != null && "chaos_glove".equals(id.method_12836()) && "star_launcher".equals(id.method_12832());
		} catch (Throwable t) {
			return false;
		}
	}
